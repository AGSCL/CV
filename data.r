...
pubs <- dplyr::tribble(
  ...
  NA, NA, "Gajardo A. I. J., Wagner T. D., Devi Howell K., González-Santa Cruz A., Kaufman J. S., Castillo-Carniglia A., Effects of 2019's social protests on emergency health services utilization and case severity in Santiago, Chile, The Lancet Regional Health Americas, 100082, DOI/URL: 10.1016/j.lana.2021.100082", 2021, NA,
...
sem <- dplyr::tribble(
  ~area, ~accomplishment, ~detail, ~year, ~where, 
  NA, NA, "González-Santa Cruz A., Castillo Carniglia A., Ambulatory or residential? a multi-state analysis of treatments for substance use disorders, Chile, College on Problems of Drug Dependence 83rd Annual Scientific Meeting, ESTADOS UNIDOS DE AMERICA, Nashville, Tennessee (online due to COVID-19)", 2021, NA,
