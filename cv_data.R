...
skills <- dplyr::tribble(
  ~area, ~skills,
  "Lenguajes de programación", "R (Intermedio-Avanzado), Python (Básico), Git (Básico)",
...
pubs <- tibble::tribble(
  ...
  NA, NA, "González-Santa Cruz A, Ruiz-Tagle J, Mateo-Pinones M, Castillo-Carniglia Á, Association between poly-substance use and substance use disorder treatment non-completion admitted to multiple treatments between 2010-2019 in Chile, Drug and Alcohol Dependence (Manuscrito enviado)", "2025", NA,
  NA, NA, "González-Santa Cruz A, Mauro PM, Sapag JC, Martins SS, Ruiz-Tagle J, Gaete J, Cerda M, Castillo-Carniglia Á, Effect of residential versus ambulatory treatment for substance use disorders on readmission risk in a register-based national retrospective cohort. Soc Psychiatry Psychiatr Epidemiol; 10.1007/s00127-025-02865-9", "2025", NA,
  ...
  NA, NA, "González-Santa Cruz A, Ansoleaga-Moreno E, Otra lección de la pandemia: relevancia del apoyo social para la protección de la salud mental en trabajadores de la salud. Revista Médica de Chile, 152(08), 875-888, 10.4067/s0034-98872024000800875","2024", NA,
  ...
  NA, NA, "Ansoleaga E, Ahumada M, González-Santa Cruz A, Association of Workplace Bullying and Workplace Vulnerability in the Psychological Distress of Chilean Workers, International journal of environmental research and public health, 16, 20, 1-14, 10.3390/ijerph16204039", "2019-2022", NA
)
...
sem <- dplyr::tribble(
  ...
  NA, NA, "González-Santa Cruz A, The role of baseline substance use treatment length of stay and time to first readmission and all-cause mortality: A 12-year nationwide retrospective data linkage cohort study”, Annual Meeting of the Society of Epidemiologic Research, Texas, US", "2024", "Disertation Workshop"#,
...
edu <- dplyr::tribble(
  ...
  "Doctorado en Salud Pública (c)", 2022, NA, "Universidad de Chile", "Santiago, Chile", NA,
...
work <- dplyr::tribble(
  ...
  "Docencia", "Magíster en Métodos de Investigación Social, Universidad Diego Portales","Noviembre",2022,"Noviembre", 2024, "Santiago, Chile", "Taller de Profundización en R; Cursos de Estadística Aplicada y Procesamiento de Datos con R, y Gestión, representación y Análisis de datos cuantitativos",
  ...
  "Asistente de Investigación", "Proyecto Fondecyt 1191282 y Proyecto Fondecyt 1170239", "Marzo", 2019, "Marzo", 2022, "Santiago, Chile", " ",
...
pubs_manual <- pubs
sem_manual <- sem
skills_manual <- skills

save.image("cv_data.RData")