...
sem <- dplyr::tribble(
  ~area, ~accomplishment, ~detail, ~year, ~where, 
    NA, NA, "González-Santa Cruz A, Castillo-Carniglia Á, Trayectorias de hospitalización por condiciones vinculadas a trastornos de salud mental y consumo de sustancias en usuarios/as jóvenes de población general y pertenecientes a pueblos originarios, 2018-2021, Chile, XVLII Jornadas Nacionales de Estadística 2024, Valdivia", "2024", "Poster",
  ...
  NA, NA, "González-Santa Cruz A, Ruiz-Tagle J, Mateo-Pinones M, Castillo-Carniglia Á, Poly-substance use, treatment completion, and contact with the justice system: a multistate analysis of treatments for substance use disorders between 2010-2019 in Chile, Portland, US", "2023", "Poster",
