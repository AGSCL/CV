...
work <- dplyr::tribble(
  ...
  "Asistente de Investigación", "Núcleo Milenio para la Evaluación y Análisis de Políticas de Drogas (MEAD), dirigido por Álvaro Castillo-Carniglia", "Marzo", 2022, "Presente", NA,"Santiago, Chile", "",
