...
\photo{CURSO-COMPUTACION-ALONSO.jpg}
\name{Andrés}{González Santa Cruz}

\position{Asistente de Investigación y Estudiante Doctorado en Salud
Pública UCH}
...
\begin{cventries}
    \cventry{Diplomado Data Science para Ciencias Sociales, Universidad Diego Portales}{Docencia}{Santiago, Chile}{Noviembre 2024 --> Enero 2025}{\begin{cvitems}
\item Reproducibilidad y comunicación de resultados
\end{cvitems}}
    \cventry{Carrera Medicina, Universidad de Chile}{Docencia}{Santiago, Chile}{Agosto 2024 --> Diciembre 2024}{\begin{cvitems}
\item Epidemiología analítica
\end{cvitems}}
...
\item  
\end{cvitems}}
    \cventry{Magíster en Métodos de Investigación Social, Universidad Diego Portales}{Docencia}{Santiago, Chile}{Noviembre 2022 --> Noviembre 2024}{\begin{cvitems}
...
\item González-Santa Cruz A, Castillo-Carniglia Á, Trayectorias de hospitalización por condiciones vinculadas a trastornos de salud mental y consumo de sustancias en usuarios/as jóvenes de población general y pertenecientes a pueblos originarios, 2018-2021, Chile, XVLII Jornadas Nacionales de Estadística 2024, Valdivia
...
\item González-Santa Cruz A, Ruiz-Tagle J, Mateo-Pinones M, Castillo-Carniglia Á, Poly-substance use, treatment completion, and contact with the justice system: a multistate analysis of treatments for substance use disorders between 2010-2019 in Chile, Portland, US
...
\begin{cventries}
    \cventry{JavaScript (Básico), R (Intermedio-Avanzado), VBA (Básico), Python (Básico)}{Lenguajes de programación}{}{}{}\vspace{-4.0mm}
    \cventry{CSS, HTML, LaTeX, RMarkdown, YAML, Git}{Otros lenguajes}{}{}{}\vspace{-4.0mm}
    \cventry{Excel, Outlook, OneNote, PowerBI, PowerPoint, Word, Google Docs, Google Spreadsheet}{Ofimáticos}{}{}{}\vspace{-4.0mm}
    \cventry{Manejo escrito y oral (ETAAPP 89\%, Level 6: Advance Step One; Duolingo English Test: 130 de 160)}{Inglés}{}{}{}\vspace{-4.0mm}
\end{cventries}
