...
\begin{cventries}
    \cventry{Proyecto Fondecyt 1240138, a cargo de Álvaro Castillo-Carniglia
}{\# Tesista
}{Santiago, Chile
}{}{\begin{cvitems}
\item  
...
\end{cvitems}}
    \cventry{Diplomado Data Science para Ciencias Sociales, Universidad Diego Portales
}{\# Docencia
}{Santiago, Chile
}{}{\begin{cvitems}
...
\end{cvitems}}
    \cventry{Carrera Medicina, Universidad de Chile
}{\# Docencia
}{Santiago, Chile
}{}{\begin{cvitems}
...
\end{cvitems}}
    \cventry{Núcleo Milenio para la Evaluación y Análisis de Políticas de Drogas (nDP), dirigido por Álvaro Castillo-Carniglia
...
\end{cvitems}}
    \cventry{Magíster en Métodos de Investigación Social, Universidad Diego Portales
}{\# Docencia
}{Santiago, Chile
}{}{\begin{cvitems}
...
\end{cvitems}}
    \cventry{Carrera Data Science, Universidad Mayor
}{\# Docencia
}{Santiago, Chile
}{}{\begin{cvitems}
...
\end{cvitems}}
    \cventry{Proyecto Fondecyt 1191282, a cargo de Álvaro Castillo-Carniglia y Proyecto Fondecyt 1170239, a cargo de Elisa Ansoleaga Moreno
}{\# Asistente de Investigación
}{Santiago, Chile
}{}{\begin{cvitems}
\item  
...
\end{cvitems}}
    \cventry{Departamento de Desarrollo de Personas, Universidad de Santiago de Chile
}{\# Analista de Desarrollo de Personas
}{Santiago, Chile
}{}{\begin{cvitems}
\item  
...
\item González-Santa Cruz A, Ansoleaga-Moreno E, Otra lección de la pandemia: relevancia del apoyo social para la protección de la salud mental en trabajadores de la salud. Revista Médica de Chile, 152(08), https://www.revistamedicadechile.cl/index.php/rmedica/article/view/10178
\item Saldías Fernández MA, Gónzalez-Santa-Cruz A, Martínez-Ordenes M, Parra-Giordano D, Factores sociodemográficos-sanitarios sobre la decisión de interrupción del embarazo, Chile: un análisis de clases latentes. Global health promotion, 1757-9759; Vol 0(0): 1–11; 1257477. 10.1177/17579759241257477
...
\item Saldias-Fernández MA, Gónzalez-Santa-Cruz A, Parra-Giordano D, Interrupción del embarazo en Chile 2018-2020: rol de las variables sociodemográficas y sanitarias sobre la decisión de la mujer. Salud Publica Mex [Internet]. 10.21149/14670
\end{cvitems}}
